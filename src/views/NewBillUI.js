            ...
            <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <input required type="file" class="form-control blue-border" data-testid="file" title="your text" />
                    <span id="error-img" data-testid="error-img">Veuillez entrer un format d'image jpg, jpeg ou png.</span>
                  </div>
                </div>
            </div>
            <div class="row">
